...
from diffusion_policy.model.diffusion.conditional_unet1d import ConditionalUnet1D, ControlNet
...
class DiffusionControlnetUnetHybridImagePolicy(BaseImagePolicy):
    def __init__(self, 
            shape_meta: dict,
    ...
    def compute_loss(self, batch):
        ...
        nobs = self.normalizer['observation_images_head_cam'].normalize(batch['observation.images.head_cam'])
