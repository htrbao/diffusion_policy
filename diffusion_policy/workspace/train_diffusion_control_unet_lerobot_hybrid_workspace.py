...
from diffusion_policy.policy.diffusion_control_unet_hybrid_image_policy import DiffusionControlnetUnetHybridImagePolicy
...
class TrainDiffusionControlnetUnetHybridWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        self.model: DiffusionControlnetUnetHybridImagePolicy = hydra.utils.instantiate(cfg.policy)

        self.ema_model: DiffusionControlnetUnetHybridImagePolicy = None
            ...
            for local_epoch_idx in range(cfg.training.num_epochs):
                ...
                if (self.epoch % cfg.training.sample_every) == 0:
                    with torch.no_grad():
                        ...
                        result = policy.predict_action(obs_dict=obs_dict, past_action=past_action)
